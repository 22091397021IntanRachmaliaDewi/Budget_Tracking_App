class Strings {
  static const retroCopy = "Selamat Datang";
  static const synthPolaroid = "Selamat Datang";
  static const keytarSweenet = "Selamat Datang";
  static const getStarted = "Masuk";
  static const retroText =
      "Selamat Datang di Aplikasi Catatan Pengeluaran, Buat Catatan Pengeluaran menjadi Lebih Mudah.  ";
  static const lorem = "Masuk dan Buat Akun Anda untuk Mencatat Pengeluaran";
  ...
  static const enterEmail =
      "Please enter your email below to receive your password and reset information";
  static const sendRequest = "Send Request";

  //reset password
  static const resetPassword = "Reset Password";
  static const resetEmail =
  ...
  static const String cellNumberRequired = "Cellphone number is Required.";
  static const String invalidCellNumber = "Cellphone number must be 10 digits.";
